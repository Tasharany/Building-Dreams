(function ($) {
  $(document).ready(function () {$("product-list").DataTable();
    // Basic table example
    $("#basic-1").DataTable();
    $("#basic-2").DataTable({
      paging: true,
...
//single row delete data table start here
    ...
    $("#addRow").on("click", function () {
      t.row.add(deleterow.$("tr.selected"))
        .draw(false);
    ...
    var t = $("#Build-Table").DataTable();
    var counter = 1;

    $("#Build-Table_addRow").on("click", function() {
      t.row.add([
        counter + ".1",
        counter + ".2",
        counter + ".3",
...
// Automatically add a first row of data
    $("#Build-Table_addRow").click();
    var bt = $("#Build-Table").DataTable();
    //var addFrom = $("#ajax-data-object-case").DataTable();
    $("#ajax-data-object-case tbody").on("click", "td.details-control", function () {
      var af = $(this).closest("tr");
      var row = addFrom.row(af);
      addTo.row.add(row)
          .draw(false);

    });

    $("#Build-Table tbody").on("click", "tr", function () {
      $(this).toggleClass("selected");
    });
    $("#Build-Table-del-btn").on("click", function () {
      bt.row(".selected").remove().draw(!1);
    });

    //Ajax Data Source (Arrays) start
    //////////////////////////////////////////////////////////////////////
    $("#ajax-data-object-case").DataTable({
      ajax: "Frontend/assets/ajax/case.txt",
      columns: [
        {
    ...
    $("#ajax-data-object-cpu").DataTable({
      ajax: "../assets/ajax/cpu.txt",
      columns: [
        {
          className: "icon-support",
          orderable: false,
    ...
    $("#ajax-data-object-cpu-cooler").DataTable({
      ajax: "../assets/ajax/cooler.txt",
      columns: [
        {
          className: "icon-support",
          orderable: false,
    ...
    $("#ajax-data-object-mb").DataTable({
      ajax: "../assets/ajax/mb.txt",
      columns: [
        {
          className: "icon-support",
          orderable: false,
    ...
    $("#ajax-data-object-ex-hd").DataTable({
      ajax: "../assets/ajax/ehd.txt",
      columns: [
        {
          className: "icon-support",
          orderable: false,
    ...
    $("#ajax-data-object-in-hd").DataTable({
      ajax: "../assets/ajax/ihd.txt",
      columns: [
        {
          className: "icon-support",
          orderable: false,
    ...
    $("#ajax-data-object-key").DataTable({
      ajax: "../assets/ajax/key.txt",
      columns: [
        {
          className: "icon-support",
          orderable: false,
    ...
    // "img-fluid table-avtar" src="../assets/images/user/2.png"
    $("#ajax-data-object-memory").DataTable({
      ajax: "../assets/ajax/memory.txt",
      columns: [
        {
          className: "icon-support",
          orderable: false,
    ...
    $("#ajax-data-object-monitor").DataTable({
      ajax: "../assets/ajax/monitor.txt",
      columns: [
        {
          className: "icon-support",
          orderable: false,
    ...
    $("#ajax-data-object-mouse").DataTable({
      ajax: "../assets/ajax/mouse.txt",
      columns: [
        {
          className: "icon-support",
          orderable: false,
    ...
    $("#ajax-data-object-ps").DataTable({
      ajax: "../assets/ajax/ps.txt",
      columns: [
        {
          className: "icon-support",
          orderable: false,
    ...
    $("#ajax-data-object-gpu").DataTable({
      ajax: "../assets/ajax/gpu.txt",
      columns: [
        {
          className: "icon-support",
          orderable: false,
    ...
    $("#ajax-data-object-web").DataTable({
      ajax: "../assets/ajax/webcam.txt",
      columns: [
        {
          className: "icon-support",
          orderable: false,
    ...
    // "img-fluid table-avtar" src="../assets/images/user/2.png"
    $("#ajax-data-object-extra").DataTable({
      ajax: "../assets/ajax/case.txt",
      columns: [
        {
          className: "icon-support",
          orderable: false,
    ...
    $("#ajax-data-object-other").DataTable({
      ajax: "../assets/ajax/case.txt",
      columns: [
        {
          className: "icon-support",
